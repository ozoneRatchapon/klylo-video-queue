...
- [x] `npm run test:ui` — 28/28 against a local production build (browser pinned to
      ...
      banner, timestamp hydration, the signed result URL, sign-out, sign-back-in and newest-first ordering.
      Also 28/28 against the deployment (`BASE_URL=https://klylo-video-queue.vercel.app`).
